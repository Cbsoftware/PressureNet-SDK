...
public class CbBgAlarm extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		serviceIntent.putExtra("bg_alarm", true);
	...
	public void setAlarm(Context context, long time) {
		...
		Intent i = new Intent("ca.cumulonimbus.pressurenetsdk.START_BG_ALARM");
	...
	public void cancelAlarm(Context context) {
		...
		Intent intent = new Intent("ca.cumulonimbus.pressurenetsdk.START_BG_ALARM");
